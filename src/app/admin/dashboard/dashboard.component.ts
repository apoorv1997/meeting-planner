...
export class DashboardComponent implements OnInit {
  ...
  */
  ...
  constructor(private modal: NgbModal, private router: Router, private _route: ActivatedRoute, private httpService: HttpServiceService, private toastr: ToastrService,
    public location: Location, private socket: SocketServiceService) {
  ...
  ngOnInit() {
    ...
    this.httpService.getEventForUser(this._route.snapshot.paramMap.get('userId')).subscribe(
      (response) => {
  ...
  closeEventInterval = () => {
    ...
    clearInterval(this.eventInterval);
    console.log(this.eventInterval);
