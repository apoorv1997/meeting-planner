...
module.exports.setRouter = (app) => {
     ...
     * @apiGroup users
     * @apiVersion  1.0.0
     * @api {post} /api/project2/users/signup api for user signup.
     *
    ...
    */
     ...
     * @apiGroup users
     * @apiVersion  1.0.0
     * @api {post} /api/project2/users/login api for user login.
     *
     * @apiParam {string} email email of the user. (body params) (required)
     * @apiParam {string} password password of the user. (body params) (required)
     * 
    ...
    */
     ...
     * @apiGroup users
     * @apiVersion  1.0.0
     * @api {post} /api/project2/users/logout api for user logout.
     *
    ...
    */
    ...
    app.post(`${appConfig.apiVersion}/resetPassword`, userController.resetPassword);

      /**
     * @apiGroup users
     * @apiVersion  1.0.0
     * @api {post} /api/project2/resetPassword api for user password reset.
     *
     * @apiParam {string} email email of the user. (body params) (required)
     * 
     * @apiSuccess {object} myResponse shows error status, message, http status code, result. 
    ...
    */
    ...
    app.get(`${baseUrl}/getUser/:userId`,auth.isAuthorized, userController.getUser);
    /**
     * @apiGroup users
     * @apiVersion  1.0.0
     * @api {get} /api/project2/users/:userId api for user info.
     *
     * @apiSuccess {object} myResponse shows error status, message, http status code, result. 
     * sends an email to user email for password reset
     * 
    ...
    */
     ...
     * @apiGroup users
     * @apiVersion  1.0.0
     * @api {post} /api/project2/users/updateUser api for user data update.
     *
     * @apiParam {string} email email of the user. (body params) (required)
     * @apiParam {string} password password of the user. (body params) (required)
     * 
    ...
    */
    ...
    app.get(`${baseUrl}/allUsers`,auth.isAuthorized,userController.allUsers);
    /**
     * @apiGroup users
     * @apiVersion  1.0.0
     * @api {get} /api/project2/users/allUsers api for all user info.
     *
     * @apiSuccess {object} myResponse shows error status, message, http status code, result.
     * 
     * @apiSuccessExample {object} Success-Response:
